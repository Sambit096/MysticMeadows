...
{
    /// <summary>
    /// Handles combat behavior including attacking, weapon equipping, and damage calculation.
    /// </summary>
    public class Fighter : MonoBehaviour, IAction, ISaveable, IModifierProvder
    {
        ...
        /// <summary>
        /// Initiates an attack on the specified combat target.
        /// </summary>
        public void Attack(GameObject combatTarget)
        {
            GetComponent<ActionScheduler>().StartAction(this);
            target = combatTarget.GetComponent<Health>();
            Debug.Log("Attack initiated on " + combatTarget.name);
        }

        /// <summary>
        /// Checks if the specified target can be attacked.
        /// </summary>
        ...
        /// <summary>
        /// Equips the specified weapon on this fighter.
        /// </summary>
